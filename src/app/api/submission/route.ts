import { SubmissionRequestSchema } from "../../../contracts/http.ts";
...
import { submitApplication } from "../../../server/services/submission.ts";
...
/**
 * Submission is the applicant's own act. It is reachable only from the Review
  ...
  switch (result.kind) {
    ...
    case "review_invalidated":
      return failure(
        409,
        "review_invalidated",
        "That review is no longer current.",
        "use_visible_application",
      );
    case "stale_state":
      return failure(
