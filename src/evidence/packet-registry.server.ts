...
export const REGISTERED_PACKET_DOCUMENTS = Object.freeze([
  Object.freeze({
    ...
    expectedSha256:
      "0a7d7c2621d5f7d372c0116991e9445052dcca4a6227253e238886d2203a2773",
    limits: PDF_LIMITS,
  }),
  Object.freeze({
    packetCode: "supported",
    ...
    expectedSha256:
      "b0a0832235875dd41cbaa37129d2bd2e4eb69daefcf25370b4cd7c4bea1365cc",
    limits: PDF_LIMITS,
  }),
  Object.freeze({
    packetCode: "supported",
    ...
    expectedSha256:
      "ade7f91327947b7faa84e475f57f9c10384c7c46d4dca0204a40b96f6996541c",
    limits: PDF_LIMITS,
  }),
  Object.freeze({
    packetCode: "conflict",
  ...
  Object.freeze({
    ...
    documentClass: "synthetic_income_statement",
    expectedSha256:
      "29a8d9c1078512ec67229ee43e0d5a653e304cd43b6957f228b4f9e49a5dc9c7",
    limits: PDF_LIMITS,
  }),
